...
class AirGapVQTransformer(nn.Module):
    def __init__(self, vocab_size, num_codes=512, code_dim=128, n_ir_tokens=20, 
                 reasoner_layers=4, reasoner_heads=4, 
                 speaker_layers=4, speaker_heads=4,
                 block_size=128):
        super().__init__()
        self.num_codes = num_codes
        # Defaults stay small for backward compatibility; training scripts supply the larger block/IR values actually used.
