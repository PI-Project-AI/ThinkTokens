...
def train():
    ...
    train_dataset = BabiDataset(data_dir, split='train')
    ...
    # V13 Model
    # Context 192 (Input) + 64 (IR) + 16 (Answer)
    model = AirGapVQTransformer(
        ...
        speaker_layers=6,
        speaker_heads=8,
        block_size=256 # Fits 192 input + 64 IR
    ).to(device)
