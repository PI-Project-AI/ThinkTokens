...
### 2.1 Copy Files
Since you are deploying from your local machine, copy the `air_gap/v18` folder to your instance.

```bash
# On your local machine
scp -r air_gap/v18 ubuntu@<YOUR_INSTANCE_IP>:~/projects/TT_v18/
```
...
cd projects/TT_v18/air_gap/v18
...
1.  Downloading the TinyStories dataset (train & valid) directly into the `air_gap/v18` folder.
...
```bash
# Ensure you are in the air_gap/v18 directory and venv is active
source .venv/bin/activate
chmod +x run_v18.sh
./run_v18.sh
```
...
```bash
# On your local machine
scp -r ubuntu@<YOUR_INSTANCE_IP>:~/projects/TT_v18/air_gap/v18/results_phase1 ./results_phase1_v18
scp -r ubuntu@<YOUR_INSTANCE_IP>:~/projects/TT_v18/air_gap/v18/results_phase2 ./results_phase2_v18
```
